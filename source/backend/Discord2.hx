...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1525646217324003368";
	...
	public static function changePresence(details:String = 'In the Main Menu', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
